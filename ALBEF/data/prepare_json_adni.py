...
path = '/content/drive/MyDrive/PhD KFUPM/Deep Learning/Term paper/Datasets/ADNI'
...
df = pd.read_csv('/content/drive/MyDrive/PhD KFUPM/Deep Learning/Term paper/Datasets/ADNI/information/CDR_19Nov2025.csv')
...
with open('/content/drive/MyDrive/PhD KFUPM/Deep Learning/Term paper/Submission/multimodalAD/ALBEF/data/ADNI.json', 'w') as f:
    json.dump(data, f)
